<?php
namespace SynDiff\Renderer\Inline;

require_once(__DIR__.'/Token.php');
require_once(dirname(__DIR__).'/lib/pear/Text/Diff/Renderer.php');
require_once(dirname(__DIR__).'/lib/ConsoleColour.php');

use \Text_Diff_Renderer;
use \ConsoleColour;
use \SynDiff\Diff\TokenList\Token;

class TokenList extends Text_Diff_Renderer
{
